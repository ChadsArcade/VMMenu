...
char        auth1[] = "VMMenu 1.5, Chad Gray";
...
void SetOptions(void)
{
   ...
   while ((cc != keyz[k_options]) && (cc != keyz[k_quit]) && timer < 1800)
   {
      ...
      PrintString("Control Panel    ", -150, top, 0, 6, 6, 0);
      if (optz[o_cpanel] == 0) PrintString("Buttons ", 259, top, 0, 6, 6, 0);
      if (optz[o_cpanel] == 1) PrintString("Joystick", 259, top, 0, 6, 6, 0);
      if (optz[o_cpanel] == 2) PrintString("Spinner ", 259, top, 0, 6, 6, 0);
      ...
      if (mousefound)
      {
         ...
         PrintString(angle, 268, top, 0, 6, 6, 0);
      ...
      switch (cursor)
      {
         ...
         case 4:     // Control Panel Type, 0=Buttons (e.g. Asteroids), 1=Joystick, 2=Spinner (e.g. Tempest)
         {
            ...
            if (optz[o_cpanel] == 0)      // Asteroids style control panel
            {
               ...
               keyz[k_pgame]  = FIRE;     // "Up"
               keyz[k_ngame]  = THRUST;   // "Down"
            }
